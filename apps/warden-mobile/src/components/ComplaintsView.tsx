...
export default function ComplaintsView({
  ...
  const getCategoryIcon = (cat, size = 16, colorOverride) => {
    const c = colorOverride || colors.outline;
    switch (cat.toLowerCase()) {
      case 'plumbing': return <Icon name="wrench" size={size} color={c} />;
      case 'electrical': return <Icon name="lightning-bolt" size={size} color={c} />;
      case 'furniture': return <Icon name="archive" size={size} color={c} />;
      case 'network': return <Icon name="wifi" size={size} color={c} />;
      default: return <Icon name="clipboard" size={size} color={c} />;
    }
  };
        ...
        <View style={styles.complaintList}>
          {filteredComplaints.length > 0 ? (
                ...
                >
                  ...
                  <View style={styles.complaintMeta}>
                    <View style={styles.complaintMetaItem}>
                      <Icon name="map-marker" size={12} color={colors.outline} />
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyText}>All clear! No complaints found</Text>
            </View>
          )}
        </View>
      </ScrollView>

      <TouchableOpacity onPress={() => setShowAddForm(true)} style={styles.fab}>
          ...
          <View style={styles.addForm}>
            <View style={styles.addFormHeader}>
              <View style={styles.addFormHeaderLeft}>
                <Icon name="hammer" size={20} color={colors.primary} />
            ...
            <ScrollView style={styles.formScroll}>
              ...
              <View style={styles.priorityRowTwo}>
                {priorities.map((p) => (
                  <TouchableOpacity
                    key={p}
            ...
            <TouchableOpacity onPress={handleCreateComplaint} style={styles.submitBtn}>
                ...
                <View style={styles.reportedByCard}>
                  <View>
                    ...
                    <Text style={styles.reportedByName}>
                      {selectedComplaint.reportedBy} ({selectedComplaint.room})
                    </Text>
                  </View>
                  <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  detailCategoryText: { fontWeight: '700', fontSize: 12, color: colors.onSurface },
  detailDesc: {
    fontSize: 12,
    color: colors.onSurface,
    fontWeight: '500',
  ...
  detailActions: { flexDirection: 'row', gap: 12, paddingTop: 16, borderTopWidth: 1, borderTopColor: colors.outlineVariant },
