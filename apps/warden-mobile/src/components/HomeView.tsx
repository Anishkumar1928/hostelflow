    ...
    <View style={styles.screen}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        <View style={styles.greeting}>
          ...
          <Text style={styles.greetingSub}>Sector 4 Block A</Text>
        </View>
            ...
            <View style={styles.overdueCard}>
              <View style={styles.alertCardHeader}>
                <View style={[styles.alertBadge, { borderColor: 'transparent' }]}>
                  ...
                  <Text style={[styles.alertBadgeText, { color: colors.tertiary }]}>
                    OVERDUE LEAVE
                  </Text>
                </View>
              ...
              <Text style={styles.alertDesc}>
                Expected return was 8:00 PM. Student is not reachable.
              </Text>
              ...
              <View style={styles.overdueActions}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    Alert.alert('Calling', 'Initiating call to Aditya Verma.');
                  }}
                  style={[
                    styles.overdueBtn,
                    calledStudent ? styles.overdueBtnSecondary : styles.overdueBtnPrimary,
                  ]}
                >
                  <Icon name="phone" size={14} color="white" />
                  <Text style={styles.overdueBtnText}>
                    {calledStudent ? 'Calling...' : 'Call Student'}
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    Alert.alert('Notified', 'SMS and Email sent to parents.');
                  }}
                  style={[
                ...
                >
                  <Icon
                    name={notifiedParents ? 'check-circle' : 'message-text'}
                    size={14}
                    color={notifiedParents ? colors.success : colors.onSurface}
                  />
                  <Text
                    style={[
                      styles.overdueBtnOutlineText,
                      notifiedParents && { color: '#166534' },
                    ]}
                  >
